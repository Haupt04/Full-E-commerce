...
const PurchaseSuccessPage = () => {
    ...
    if (isProcess) return <LoadingSpinner />;
        ...
        <div className='max-w-md w-full bg-gray-800 rounded-lg shadow-xl overflow-hidden relative z-10'>
            <div className='p-6 sm:p-8'>
                ...
                <div className='space-y-4'>
                    <button className='w-full bg-gray-600  text-orange-400 font-bold py-2 px-4 rounded-lg transition duration-300 flex items-center justify-center'>
                        <HandHeart className='mr-2' size={18} />
                        Thank you for trusting us
                    </button>
                    <Link to="/"className='w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300 flex items-center justify-center'>
                        Continue Shopping
